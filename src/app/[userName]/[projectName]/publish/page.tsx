...
export default async function PublishPage({ params: params_ }: { params: Promise<Params> }) {
  ...
  return (
    <>
      ...
      <p>
        A publication is served from a separate address, to anybody who has the link, with no sign-in. Publishing does
        not change who can see the project itself: a private project can have a public publication.
      </p>
      ...
      {manifest.type === 'missing' && (
        <section className='publish-card'>
          ...
          <p>
            Add a <code>{PUBLISH_MANIFEST_FILE}</code> file to the root of this project, declaring what it publishes.
            For a Verso manual generated by the Lake executable <code>generate-book</code>:
          </p>
